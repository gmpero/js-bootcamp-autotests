...
class HomePage extends Layout {
    ...
    getLocatorDistributedBuildTitle = () => this.page.locator(".empty-state-section h2.h4").nth(1);
    getLocatorDistributedBuildLinks = () => this.page.locator(".empty-state-section-list").nth(1).locator('.content-block__link');;
